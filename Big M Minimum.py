...
def print_standard_form(n, m, a, c, d, b, s, M, optimization):
    ...
    print("The number of Slack variables is: ", num_slack_variables)
    print("The number of Artificial variables is: ", num_artificial_variables)
    print("The number of Surplus variables is: ", num_surplus_variables)
